...
class LogViewerApp extends KioskApp {
  ...
  _fetchLog() {
    ...
    this.apiContext.fetchFromApi("logviewer", `${this.logFilename}/log-lines`, {
      ...
      if (c2 - 1 > 0 && (c2 - 1) % this.MAX_LINES !== 0) {
